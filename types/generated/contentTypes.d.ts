...
export interface ApiMainLogoMainLogo extends Schema.CollectionType {
  collectionName: 'main_logos';
  info: {
    singularName: 'main-logo';
    pluralName: 'main-logos';
...
export interface ApiSocailSocail extends Schema.CollectionType {
  collectionName: 'socails';
  info: {
    singularName: 'socail';
    pluralName: 'socails';
    displayName: 'socail';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::main-logo.main-logo': ApiMainLogoMainLogo;
      'api::metadata.metadata': ApiMetadataMetadata;
      'api::service.service': ApiServiceService;
      'api::socail.socail': ApiSocailSocail;
    }
  }
}
